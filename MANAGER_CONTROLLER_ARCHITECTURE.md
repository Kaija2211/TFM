...
The next intended extraction is a shared AI squad depth/need evaluator, building on `ManagerAiSquadRotation`'s Condition/injury-aware selection to drive recruitment and replacement decisions.
