...
Partial files are a navigation and merge-conflict improvement, not permission to keep growing the controller indefinitely. New reusable football logic should live in focused classes and be called by the relevant partial. Examples include `ManagerAiTacticalPlanner`, `ManagerTacticalShape`, `ManagerPlayerDerivedStrength`, and the planned AI squad evaluator.
...
The next intended extraction is a shared AI squad evaluator used by rotation, depth analysis and recruitment.
